...
class HomePageTest(TestCase):
    ...
    def xxx_test_can_save_a_POST_request(self):
    ...
    def xxx_test_redirects_after_POST(self):
    ...
    def xxx_test_only_saves_items_when_necessary(self):
        self.client.get('/')
        self.assertEqual(Item.objects.count(), 0)

    def xxx_test_displays_all_list_items(self):
...
class ListViewTest(TestCase):
    ...
    def xxx_test_displays_all_items(self):
        list_ = List.objects.create()
